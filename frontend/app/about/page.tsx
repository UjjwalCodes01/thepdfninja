...
export const metadata: Metadata = {
  ...
  description: 'Learn about ThePDFNinja, built by Anaya Digital Marketing Agency. Our mission: free, fast, and private PDF tools for everyone. 23 tools, no signup, no watermarks.',
  alternates: {
  ...
  openGraph: {
    ...
    title: 'About ThePDFNinja — Free PDF Tools Built by Anaya Digital',
    description: 'ThePDFNinja provides 23 free online PDF tools with no account required. Built and maintained by Anaya Digital Marketing Agency.',
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: 'ThePDFNinja provides 23 free online PDF tools including merge, split, compress, convert PDF to Word, Excel, JPG, and more. Built by Anaya Digital.',
            foundingDate: '2025',
            founder: {
              '@type': 'Organization',
              name: 'Anaya Digital',
      ...
      <section style={{ padding: '80px 0', background: 'white' }}>
        <div className="container" style={{ maxWidth: '800px' }}>
          <div className="prose">
            ...
            <p>
              By leveraging modern web technologies — including a <strong>Next.js</strong> frontend, <strong>AWS Lambda</strong> serverless processing, and <strong>Ghostscript / LibreOffice</strong> on the backend — we offer 23 premium-grade PDF tools directly in your browser. No installation, no account, no friction.
            </p>
            ...
            <p>
              You might wonder how we can offer 23 complex tools for free. ThePDFNinja is supported by minimal, non-intrusive advertising (Google AdSense) and efficient serverless infrastructure on AWS. This allows us to keep the core service 100% free forever, with no watermarks, no file limits, and no required accounts.
            </p>
