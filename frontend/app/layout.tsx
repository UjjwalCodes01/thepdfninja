    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'ThePDFNinja — 23 Free Online PDF Tools',
      },
    ],
  },
  twitter: {
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify([
              ...
              },
              {
                ...
                description: 'ThePDFNinja provides 23 free online PDF tools including merge, split, compress, and convert. Built by Anaya Digital.',
                foundingDate: '2025',
              ...
              },
              {
                ...
                description: 'Free online PDF tools: merge, split, compress, convert PDF to Word, Excel, JPG, PowerPoint and more. 23 tools, no signup required.',
                url: 'https://thepdfninja.com',
                datePublished: '2025-01-01',
                dateModified: '2026-06-01',
                softwareVersion: '2.0',
