      ...
      <section style={{ padding: '80px 0', background: 'white' }}>
        <div className="container" style={{ maxWidth: '800px' }}>
          <div className="prose">
            ...
            <ul>
              <li><strong>Ad Serving & Data Collection:</strong> We use Google AdSense to serve ads on this site. In the course of ads being served on this website, Google and other third-party vendors may place and read cookies on your browser, or use web beacons, IP addresses, and other tracking technologies to collect information to serve personalized ads based on your prior visits to this and other websites.</li>
