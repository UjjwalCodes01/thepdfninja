        ...
        <div className="container" style={{ maxWidth: '800px' }}>
          <div className="prose">
            ...
            <ul>
              ...
              <li><strong>Your Consent Choice:</strong> When you first visit ThePDFNinja, a cookie banner lets you accept or decline non-essential (advertising and analytics) cookies. We honour this choice using Google Consent Mode &mdash; if you decline, personalised advertising and analytics cookies are not set. You can clear your choice any time by clearing this site&rsquo;s data in your browser.</li>
