export const splitContent = {
  ...
  useCases: [
    {
      title: "Extracting Specific Chapters or Sections",
      description: "When studying from digital textbooks or reviewing extensive technical manuals, navigating through hundreds of pages to find a specific chapter is inefficient. With our PDF splitter, you can easily isolate the exact chapter or section you are currently focusing on. By extracting just the pages you need, you create a focused, lightweight document that is much easier to read on mobile devices, tablets, or e-readers, minimizing distractions and improving your study or work efficiency."
    },
    {
      title: "Sharing Confidential or Relevant Information",
      description: "In professional environments, you often need to share information from a larger document without exposing the entire file. For example, a financial controller might need to send page 42 of a quarterly report to a specific investor, or an HR manager might need to extract a single employee's review from a consolidated department file. Splitting the PDF ensures that you only share the precise data intended for the recipient, protecting sensitive information and maintaining confidentiality."
    },
    {
      title: "Optimizing Files for Email Attachments",
      description: "Large PDF files often exceed the attachment size limits imposed by email providers like Gmail or Outlook. If you have a massive presentation or portfolio, you might not be able to send it as a single file. By splitting the document into logical sections—such as breaking a presentation down into its core modules—you can significantly reduce the file size of each component, making it easy to email them to colleagues or clients without relying on third-party file-sharing links."
    },
    {
      title: "Preparing Documents for E-Signatures",
  ...
  comparison: {
    ...
    points: [
      "No Imposed Limits: Competing platforms often restrict you to splitting files under a certain size (e.g., 5MB) or limit you to a few operations per day. ThePDFNinja offers unlimited splitting for files up to 100MB, completely free.",
      "Instant Processing: Complex splits on large documents can cause other online tools to hang or crash. Our AWS-powered backend processes your requests concurrently, delivering your split files in a fraction of the time.",
      "Clean, Ad-Free Experience: We don't believe in cluttering your workspace with intrusive pop-ups or banner ads. Our interface is clean, focused, and designed to get you in and out as quickly as possible.",
